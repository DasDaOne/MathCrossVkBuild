...
var ASM_CONSTS = {
  3386636: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3386691: function($0) {performance.now = function() { return $0; };},  
 3386739: function($0) {performance.now = function() { return $0; };},  
 3386787: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3386842: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3386903: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3386967: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  var vkGames = {bridge:undefined,isInitialized:false,vkWebAppInit:function (successCallbackPtr, errorCallbackPtr, isTest) {
  ...
  function _IsValidJson(jsonStringPtr) {
          var json = UTF8ToString(jsonStringPtr);
          try {
  ...
  var background = {changeBackground:function(filePath) {
              document.body.style.backgroundImage = 'url(' + filePath + ')';
              document.body.style.backgroundSize = '100% auto';
          }};
  function _ShowBackground(filePathPtr) {
          var filePath = UTF8ToString(filePathPtr);
          background.changeBackground(filePath);
      }

  function _ShowInterstitialAds(openCallbackPtr, errorCallbackPtr) {
          vkGames.throwIfSdkNotInitialized();
  
          vkGames.vkWebAppShowInterstitialAd(openCallbackPtr, errorCallbackPtr);
      }

  function _ShowInviteBox(successCallbackPtr, errorCallbackPtr) {
          vkGames.throwIfSdkNotInitialized();
  
          vkGames.vkWebAppShowInviteBox(successCallbackPtr, errorCallbackPtr);
      }

  function _ShowRewardedAds(rewardedCallbackPtr, errorCallbackPtr) {
          vkGames.throwIfSdkNotInitialized();
  
          vkGames.vkWebAppShowRewardedAd(rewardedCallbackPtr, errorCallbackPtr);
      }

  function _StorageGetCloudSaveData(keysJsonArrayPtr, successCallbackPtr, errorCallbackPtr) {
          vkGames.throwIfSdkNotInitialized();
  ...
  function _StorageSetCloudSaveData(keyStringPtr, valueStringPtr, successCallbackPtr, errorCallbackPtr) {
          vkGames.throwIfSdkNotInitialized();
  ...
  function _WebAppInit(successCallbackPtr, errorCallbackPtr, isTest) {
          isTest = !!isTest;
...
var asmLibraryArg = {
  ...
  "StorageGetCloudSaveData": _StorageGetCloudSaveData,
  "StorageSetCloudSaveData": _StorageSetCloudSaveData,
...
unexportedRuntimeFunction('background', false);
unexportedRuntimeFunction('background__user', false);
